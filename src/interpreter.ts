...
export class Interpreter {
  ...
  private installBuiltins() {
    ...
    def("haqiqiy", (args) => { const v = args[0]; if (typeof v === "number") return v; if (typeof v === "string") { const n = parseFloat(v); if (Number.isNaN(n)) throw new MittiRuntimeError(`'${v}' ni songa aylantirib bo'lmadi`, 0); return n; } throw new MittiRuntimeError(`haqiqiy() '${typeName(v)}' uchun ishlamaydi`, 0); });
